...
const LIBKEY="grist-migration:v28:library", CONNKEY="grist-migration:v28:conn";
...
function renderManualMapping(){
 ...
 if(!m){b.innerHTML='<tr><td colspan="10">Aucun mapping.</td></tr>';return}
 m.rules=m.rules||[];
 ...
 }).join("")||'<tr><td colspan="10">Aucune liaison.</td></tr>';
